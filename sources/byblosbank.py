...
class ByblosBank(abstractions.Source):
    url = "https://www.byblosbankarmenia.am/en"
    available_currencies = ("USD", "EUR", "GBP", "RUB")
    ...
    async def parse_html(self, task, currency_name = None):
        ...
        currency_rows = parsed_html.find( class_="currency_table").find_all("tr")
